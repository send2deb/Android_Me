...
public class BodyPartFragment extends Fragment {
    ...
    // Compelted (3) Create final Strings to store state information about the list of images and list index
    private final String LIST_INDEX_KEY = "list_index";
    private final String IMAGE_LIST_KEY = "image_list";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(IMAGE_LIST_KEY);
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(IMAGE_LIST_KEY, (ArrayList<Integer>) mImageIds);
